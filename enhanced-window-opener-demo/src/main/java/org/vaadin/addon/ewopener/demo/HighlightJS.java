...
@JavaScript({
    ...
    "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.6.0/languages/java.min.js",
    "highlightjs_connector.js"
})
@StyleSheet({
    "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.6.0/styles/atom-one-dark.min.css"
})
